...
class EmailService {
    ...
    `;
        try {
            await this.transporter.sendMail({
                from: `"AquaGlow Auto Spa" <${env_1.config.EMAIL_FROM}>`,
    ...
    async sendStatusUpdate(booking, oldStatus) {
        ...
        const statusMessages = {
            [Booking_1.BookingStatus.PENDING]: 'is pending confirmation',
            [Booking_1.BookingStatus.CONFIRMED]: 'has been confirmed',
            [Booking_1.BookingStatus.COMPLETED]: 'has been completed',
            [Booking_1.BookingStatus.CANCELLED]: 'has been cancelled',
        };
        const html = `
      <!DOCTYPE html>
      <html>
